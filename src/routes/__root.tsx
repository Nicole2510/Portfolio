    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page slipped through the seams. Let's get you back.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nicole Bishop-Adigwe" },
      {
        name: "description",
        content:
          "Portfolio of Nicole Bishop-Adigwe, a Computer Engineer building software, AI, computer vision, and embedded systems with an eye for design.",
      },
      { name: "author", content: "Nicole Bishop-Adigwe" },
      { property: "og:title", content: "Nicole Bishop-Adigwe" },
      {
        property: "og:description",
        content: "Software, AI, and engineering work by Nicole. Intelligent, creative, polished.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter+Tight:wght@300;400;500;600;700&family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,500;9..144,600&display=swap",
      },
    ],
  }),
